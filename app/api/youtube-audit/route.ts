...
<body style="margin:0;padding:0;background:#f3f4f6;font-family:'Segoe UI',Helvetica,Arial,sans-serif;">
  ...
  <div style="background:linear-gradient(135deg,#ff0000 0%,#ff6a00 100%);padding:40px 24px;text-align:center;">
    <div style="display:inline-block;background:rgba(255,255,255,0.15);border-radius:12px;padding:8px 20px;margin-bottom:20px;">
      <span style="color:rgba(255,255,255,0.9);font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:0.1em;">YouTube Retention Audit by Anuj Mishra</span>
    </div>
  ...
  <div style="max-width:680px;margin:0 auto;padding:32px 16px 0;">
    ...
    <div style="background:linear-gradient(135deg,#1c1b1c,#2d1e6e);border-radius:16px;padding:32px;text-align:center;margin:24px 0;">
      ...
      <a href="https://anuj4u.in/contact" style="display:inline-block;background:#ff0000;color:white;font-weight:700;padding:14px 32px;border-radius:12px;text-decoration:none;font-size:15px;">Book a Free Strategy Call →</a>
    </div>
    ...
    <div style="text-align:center;padding:24px 0 40px;color:#9ca3af;font-size:12px;">
      ...
      <p style="margin:0;">You received this because you requested a YouTube retention audit from anuj4u.in</p>
    </div>
  </div>
</body>
</html>`;
